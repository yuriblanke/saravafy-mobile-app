...
import { useHomeAddToCollectionMutation } from "@/src/screens/Home/hooks/useHomeAddToCollectionMutation";
import { useHomeCreateCollectionMutation } from "@/src/screens/Home/hooks/useHomeCreateCollectionMutation";
...
export default function Home() {
  ...
  const addToCollectionMutation = useHomeAddToCollectionMutation({
    userId,
    onError: setAddError,
  });
  ...
  const createCollectionMutation = useHomeCreateCollectionMutation({
    userId,
    onError: (msg) => {
